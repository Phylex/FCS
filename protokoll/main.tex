...
\newcommand{\emailadressen}{uoiyc@student.kit.edu; uxehi@student.kit.edu}
% optionale Angabe von Emailadresse(n) für den Kontakt mit dem Betreuer

\newcommand{\versuch}{Fluorescent Correlation Spectroscopy} % Name des Versuchs
...
\newcommand{\durchgefuehrt}{17.05.21}      % Datum, an dem der Versuch 
                                           % durchgeführt wurde
...
\begin{document}
	...
	\chapter{Theory of FCS}             % usage: \emptychapter[page displayed 
    \input{./chap/theory.tex}           %        in toc]{name of the chapter}
